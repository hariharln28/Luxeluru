...
export function SalonCard({ salon, distance }: SalonCardProps) {
  ...
  return (
    <Link to={`/salons/${salon.id}`} className="luxe-card group overflow-hidden transition hover:border-[#c9a962]/40 hover:shadow-lg hover:shadow-[#c9a962]/5">
      ...
      <div className="p-4">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <span className="text-xs text-[#c9a962]">{tr('viewDetails')} →</span>
        </div>
